...
const BookingModal = ({ resourceId, resourceName, slot, onClose, onSuccess }) => {
  ...
  const isAvailable = availability.availableSlots > 0;
  const willBeWaitlisted = !isAvailable;
      ...
      <div className="card max-w-md w-full p-8 animate-slide-up">
        ...
        <div className="space-y-4 mb-6">
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            <span className="font-semibold text-white">
              {availability.confirmedBookings || 0} / {availability.capacity || 0}
            </span>
          </div>
        ...
        <div className="flex gap-3">
          <button
            ...
            disabled={loading}
            className={`flex-1 btn ${willBeWaitlisted ? 'btn-accent' : 'btn-primary'} btn-lg`}
          >
            {loading ? (
              <>
              ...
              <>
                ...
                {willBeWaitlisted ? 'Join Waitlist' : 'Confirm Booking'}
              </>
            )}
          </button>
          <button
